...
ocu_1_2 = import(file = "/Users/ricardoandressilvatorres/OneDrive - Universidad de los Andes/TallerR - 2021-2/data_r/data_6/input/ocupados mes 1 & 2.RDS")
...
# 1 variable
dev.off()
grid.raster(readPNG("/Users/ricardoandressilvatorres/OneDrive - Universidad de los Andes/TallerR - 2021-2/data_r/data_6/input/pics/one_var.png"))
...
# 2 variables
dev.off()
grid.raster(readPNG("/Users/ricardoandressilvatorres/OneDrive - Universidad de los Andes/TallerR - 2021-2/data_r/data_6/input/pics/two_var.png"))
